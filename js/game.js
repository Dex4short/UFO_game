...
var AirPlane = function () {
    ...
    var geomCabin = new THREE.CylinderGeometry(60, 100, 20, 32, 1);
    ...
    var geomEngine = new THREE.SphereGeometry(4, 16, 16);
    ...
    for (var i = 0; i < 8; i++) {
        ...
        engine.position.set(
            Math.cos(angle) * 75, // Radius of the saucer edge
            -5,
            Math.sin(angle) * 75
        );
    ...
    // Wings
    var geomWindshield = new THREE.SphereGeometry(
        40,
        32,
        16,
        0,
    ...
    var geomPropeller = new THREE.CylinderGeometry(5, 50, 200, 32, 1, true);
